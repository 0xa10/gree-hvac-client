...
class Client extends EventEmitter {
    ...
    _handleUpdateConfirmResponse(pack) {
        ...
        pack.opt.forEach((opt, i) => {
            const dat = pack.val ?? pack.p; // See https://github.com/cmroche/greeclimate/commit/f1993e1c6a582d701bf7b354f3b60e7e229f939a
            updatedProperties[opt] = dat[i];
            this._properties[opt] = dat[i];
        });
